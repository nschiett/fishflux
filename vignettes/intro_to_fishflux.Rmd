...
## Plot one variable:
fishflux::plot_cnp(model, x = "tl", y = "P_ex", probs = c(0.5, 0.8, 0.95))
## Plot multiple variables:
fishflux::plot_cnp(model, x = "tl", y = c("P_ex", "P_eg", "P_in", "P_g"), probs = 0.5)
```
\newline
...
```{r, message=FALSE}
## General overview:
fishflux::sensitivity(TL = 10, param = param_zebsco, par = c("Fn_sd", "Fp_sd", "Qc_sd", "Qn_sd", "Qp_sd", "k_sd"), out = c("N_ex", "P_ex", "C_in", "C_g", "N_in", "P_in"))
```
\newline
## More information
