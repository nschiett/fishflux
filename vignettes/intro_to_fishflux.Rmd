...
oto_growth <- fishflux::oto_growth(length = sarmi$length, age = sarmi$age, id = sarmi$id, linf_m = 16)
oto_growth$result
## linf_m indicates the prior knowledge on this parameters. The species has a maximum length of 16 cm. 
