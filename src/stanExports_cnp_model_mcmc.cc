...
#include "stanExports_cnp_model_mcmc.h"

RCPP_MODULE(stan_fit4cnp_model_mcmc_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_cnp_model_mcmc")
