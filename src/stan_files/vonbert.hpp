...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(99, 97, "end", "model_vonbert");
    return reader;
}
...
public:
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            vector<local_scalar_t__> z_linf;
            ...
            stan::math::assign(sigma_k, stan::math::sqrt(sigmasq_k));
            current_statement_begin__ = 45;
            stan::math::assign(sigma_linf, stan::math::sqrt(sigmasq_linf));
            current_statement_begin__ = 46;
            stan::math::assign(sigma_t0, stan::math::sqrt(sigmasq_t0));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  nlp_linf(static_cast<Eigen::VectorXd::Index>(N));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  nlp_k(static_cast<Eigen::VectorXd::Index>(N));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  nlp_t0(static_cast<Eigen::VectorXd::Index>(N));
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                stan::model::assign(nlp_linf, 
                            ...
                            (stan::model::rvalue(nlp_linf, stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), "nlp_linf") + get_base1(z_linf,get_base1(ind,n,"ind",1),"z_linf",1)), 
                            "assigning variable nlp_linf");
                current_statement_begin__ = 69;
                stan::model::assign(nlp_k, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                            (stan::model::rvalue(nlp_k, stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), "nlp_k") + get_base1(z_k,get_base1(ind,n,"ind",1),"z_k",1)), 
                            "assigning variable nlp_k");
                current_statement_begin__ = 70;
                stan::model::assign(nlp_t0, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                            (stan::model::rvalue(nlp_t0, stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), "nlp_t0") + get_base1(z_t0,get_base1(ind,n,"ind",1),"z_t0",1)), 
                            "assigning variable nlp_t0");
                current_statement_begin__ = 72;
                lp_accum__.add(normal_log<propto__>(get_base1(l,n,"l",1), (get_base1(nlp_linf,n,"nlp_linf",1) * (1 - stan::math::exp((-(get_base1(nlp_k,n,"nlp_k",1)) * (get_base1(age,n,"age",1) - get_base1(nlp_t0,n,"nlp_t0",1)))))), sigma));
            }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.push_back(sigma_t0);
            ...
            local_scalar_t__ mu_t0;
            (void) mu_t0;  // dummy to suppress unused var warning

            stan::math::initialize(mu_t0, DUMMY_VAR__);
            ...
            for (int n = 1; n <= N; ++n) {
                ...
                stan::model::assign(y_rep, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                            (get_base1(nlp_linf,n,"nlp_linf",1) * (1 - stan::math::exp((-(get_base1(nlp_k,n,"nlp_k",1)) * (get_base1(age,n,"age",1) - get_base1(nlp_t0,n,"nlp_t0",1)))))), 
