...
get_B0_rng(const T0__& troph_m,
    ...
    try {
        ...
        stan::math::initialize(Er, std::numeric_limits<double>::quiet_NaN());
        stan::math::fill(Er,DUMMY_VAR__);
        stan::math::assign(Er,0.69999999999999996);
        current_statement_begin__ = 13;
        fun_scalar_t__ Ei;
        (void) Ei;  // dummy to suppress unused var warning

        stan::math::initialize(Ei, std::numeric_limits<double>::quiet_NaN());
        stan::math::fill(Ei,DUMMY_VAR__);
        stan::math::assign(Ei,2.4300000000000002);
        ...
        stan::math::assign(tl,0.81000000000000005);
        current_statement_begin__ = 15;
        fun_scalar_t__ lnb0tc;
        (void) lnb0tc;  // dummy to suppress unused var warning

        stan::math::initialize(lnb0tc, std::numeric_limits<double>::quiet_NaN());
        stan::math::fill(lnb0tc,DUMMY_VAR__);
        stan::math::assign(lnb0tc,log(b0));
        ...
        stan::math::assign(k,(8.6199999999999992 * pow(10,-(5))));
        current_statement_begin__ = 17;
        fun_scalar_t__ Tc;
        (void) Tc;  // dummy to suppress unused var warning

        stan::math::initialize(Tc, std::numeric_limits<double>::quiet_NaN());
        stan::math::fill(Tc,DUMMY_VAR__);
        stan::math::assign(Tc,293.14999999999998);
        current_statement_begin__ = 18;
        fun_scalar_t__ Tk;
        (void) Tk;  // dummy to suppress unused var warning

        stan::math::initialize(Tk, std::numeric_limits<double>::quiet_NaN());
        stan::math::fill(Tk,DUMMY_VAR__);
        stan::math::assign(Tk,(temp + 273.14999999999998));
        current_statement_begin__ = 19;
        fun_scalar_t__ Topt;
        (void) Topt;  // dummy to suppress unused var warning

        stan::math::initialize(Topt, std::numeric_limits<double>::quiet_NaN());
        stan::math::fill(Topt,DUMMY_VAR__);
        stan::math::assign(Topt,306.39999999999998);
        current_statement_begin__ = 20;
        fun_scalar_t__ kt;
        (void) kt;  // dummy to suppress unused var warning

        stan::math::initialize(kt, std::numeric_limits<double>::quiet_NaN());
        ...
        stan::math::initialize(ktop, std::numeric_limits<double>::quiet_NaN());
        ...
        stan::math::initialize(lnB0, std::numeric_limits<double>::quiet_NaN());
        stan::math::fill(lnB0,DUMMY_VAR__);
        stan::math::assign(lnB0,(((lnb0tc + (tl * log(troph))) + (Er * kt)) - log((1 + ((Er / (Ei - Er)) * exp((Ei * ktop)))))));
