...
![packageversion](https://img.shields.io/badge/Package%20version-`r version`-blue.svg)
...
[![CRAN status](https://www.r-pkg.org/badges/version/fishflux)](https://cran.rstudio.com/web/packages/fishflux/index.html)
...
For more information on the theoretical framework behind `cnp_model_mcmc()`,
check out the [paper](https://doi.org/10.1111/1365-2435.13618).
...
Please follow these steps to install the latest version of the package from Github.
...
library(fishflux)
```
Note that if you are using a linux operating system, you still need a c++ compiler to install the package from CRAN. 
If you are using Windows or Mac, you can install a pre-compiled binary version and thus don't need a compiler. 
...
Schiettekatte NMD, Barneche DR, Villéger S, Allgeier JE, Burkepile DE, Brandl, SJ, Casey, JM, Mercière, A, Munsterman, KS, Morat, F and Parravicini, V, Nutrient limitation, bioenergetics, and stoichiometry: a new model to predict elemental fluxes mediated by fishes. Funct Ecol. 2020;00:1-13. https://doi.org/10.1111/1365-2435.13618
