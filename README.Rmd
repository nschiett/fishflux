...
Please follow these steps to install the development version of the package from Github.
...
This R package is provided for use under the MIT License ([MIT](https://opensource.org/licenses/MIT)) by the author.
